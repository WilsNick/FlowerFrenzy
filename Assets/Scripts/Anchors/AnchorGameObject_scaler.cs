...
[ExecuteInEditMode]
public class AnchorGameObject_scaler : MonoBehaviour
{
    ...
    private float screenx = 1440;
    private float screeny = 2960;
    ...
    void SetAnchor(Vector3 anchor)
    {
        ...
        float newheight = scale.y*(Screen.height/screeny)*2;
        float newwidth = scale.x*(Screen.width/screenx)*2;
